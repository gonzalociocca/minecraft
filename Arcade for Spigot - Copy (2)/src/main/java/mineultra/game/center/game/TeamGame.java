...
{
    private HashMap<String, Long> _rejoinTime;
    protected HashMap<String, GameTeam> RejoinTeam;
    ...
    public TeamGame(final centerManager manager, final GameType gameType, final Kit[] kits, final String[] gameDesc) {
        ...
        this._rejoinTime = new HashMap<String, Long>();
        this.RejoinTeam = new HashMap<String, GameTeam>();
    }
