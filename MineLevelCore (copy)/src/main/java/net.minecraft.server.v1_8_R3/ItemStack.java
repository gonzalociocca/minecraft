...
public final class ItemStack {
    ...
    public boolean placeItem(EntityHuman entityhuman, World world, BlockPosition blockposition, EnumDirection enumdirection, float f, float f1, float f2) {
        ...
        if (flag && world.captureTreeGeneration && world.capturedBlockStates.size() > 0) {
            ...
            List<BlockState> blocks = (List<BlockState>) new ArrayList();
        ...
        if (flag) {
            ...
            world.capturedBlockStates.clear();
            if (blocks.size() > 1) {
                placeEvent = org.bukkit.craftbukkit.v1_8_R3.event.CraftEventFactory.callBlockMultiPlaceEvent(world, entityhuman, blocks, blockposition.getX(), blockposition.getY(), blockposition.getZ());
            } else if (blocks.size() == 1) {
                placeEvent = org.bukkit.craftbukkit.v1_8_R3.event.CraftEventFactory.callBlockPlaceEvent(world, entityhuman, blocks.get(0), blockposition.getX(), blockposition.getY(), blockposition.getZ());
            }
        ...
        if (!this.e()) {
            ...
            if (i > 0) {
                ...
                if (entityliving instanceof EntityPlayer) {
                    org.bukkit.craftbukkit.v1_8_R3.inventory.CraftItemStack item = org.bukkit.craftbukkit.v1_8_R3.inventory.CraftItemStack.asCraftMirror(this);
            ...
            if (this.e()) {
                if (this.isDamaged(i, entityliving.bc(), entityliving)) { // Spigot
                    ...
                    if (this.count == 0 && entityliving instanceof EntityHuman) {
                        org.bukkit.craftbukkit.v1_8_R3.event.CraftEventFactory.callPlayerItemBreakEvent((EntityHuman) entityliving, this);
                    }
                    // CraftBukkit end
