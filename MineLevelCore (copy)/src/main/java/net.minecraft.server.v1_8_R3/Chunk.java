...
public class Chunk {
    ...
    public Chunk(World world, int i, int j) {
        ...
        this.entitySlices = (List[])new ConcurrentArrayList[16]; // Spigot
        for (int k = 0; k < this.entitySlices.length; ++k) {
            this.entitySlices[k] =  new ConcurrentArrayList();//new org.bukkit.craftbukkit.v1_8_R3.util.UnsafeList();
        }
    ...
    public void addEntities() {
        ...
        for (int i = 0; i < this.entitySlices.length; ++i) {
            ...
            for(Entity entity : entitySlices[i]) {
                entity.ah();
            }
    ...
    public void a(Entity entity, AxisAlignedBB axisalignedbb, List<Entity> list, Predicate<? super Entity> predicate) {
        ...
        for (int k = i; k <= j; ++k) {
            ...
            if (!this.entitySlices[k].isEmpty()) {
                for(Entity entity1 : entitySlices[i]) {
