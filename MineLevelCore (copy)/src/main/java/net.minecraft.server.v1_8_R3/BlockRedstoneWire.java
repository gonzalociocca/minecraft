...
public class BlockRedstoneWire extends Block {
    ...
    private final Set<BlockPosition> R = Collections.synchronizedSet(new HashSet());
...
//MineLevel
    ...
    private IBlockData e(World world, BlockPosition blockposition, IBlockData iblockdata,int limit) {
        limit++;
        if(limit>50){
            return iblockdata;
        }
        ...
        while (iterator.hasNext()) {
            ...
            world.applyPhysics(blockposition1, this,limit);
        }
    ...
    private void e(World world, BlockPosition blockposition) {
        if (world.getType(blockposition).getBlock() == this) {
            world.applyPhysics(blockposition, this,0);
            EnumDirection[] aenumdirection = EnumDirection.values();
            ...
            for (int j = 0; j < i; ++j) {
                ...
                world.applyPhysics(blockposition.shift(enumdirection), this,0);
            }
    ...
    public void onPlace(World world, BlockPosition blockposition, IBlockData iblockdata) {
        if (!world.isClientSide) {
            this.e(world, blockposition, iblockdata,0);
    ...
    public void doPhysics(World world, BlockPosition blockposition, IBlockData iblockdata, Block block,int limit) {
        if (!world.isClientSide) {
            if (this.canPlace(world, blockposition)) {
                this.e(world, blockposition, iblockdata,limit);
            } else {
