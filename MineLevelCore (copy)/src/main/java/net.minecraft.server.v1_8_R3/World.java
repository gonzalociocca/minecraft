...
public abstract class World implements IBlockAccess {
    ...
    public List<BlockState> capturedBlockStates = new ConcurrentArrayList<BlockState>(){
        @Override
    ...
    public void tickEntities() {
        ...
        org.spigotmc.ActivationRange.activateEntities(World.this); // Spigot
        ...
        for (entityLimiter.initTick();
             ...
             tickPosition++, entitiesThisCycle++) {
                ...
                Entity entity = (Entity) entityList.get(tickPosition);
        ...
        if (!b.isEmpty()) {
            for (int l = 0; l < b.size(); ++l) {
                TileEntity tileentity1 = (TileEntity) b.get(l);
                ...
                if (!tileentity1.x()) {
                    ...
                    if (isLoaded(tileentity1.getPosition())) {
                        getChunkAtWorldCoords(tileentity1.getPosition()).a(tileentity1.getPosition(), tileentity1);
                    }

                    World.this.notify(tileentity1.getPosition());
                }
            }
