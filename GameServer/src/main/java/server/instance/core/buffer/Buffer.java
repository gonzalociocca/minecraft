...
public class Buffer {
    ...
    public Buffer(GameBuffer manager, String reason, LivingEntity ent, LivingEntity source, BufferType type, int mult, int ticks, boolean add, Material visualType, byte visualData, boolean showIndicator, boolean ambient) {
        Manager = manager;
    ...
    public void Apply(GameServer game) {
        _live = true;
