...
public class BooleanEditor extends ClassEditor {

    static String[] usageArray = new String[]{
            "",
            Code.Color("&eValor:&f <Boolean>"),
            Code.Color("&eEjemplo:&f True, False"),
            ""
    };
    ...
    public void edit(Player player, Object object, Field field, MenuGenerator menuGenerator) {
        ...
        ChatAPI.addChatCallable(player, new ChatCallable() {
            ...
            public boolean onChat(Player player, String message) {
                Boolean result = Boolean.valueOf(message);
                try {
                    field.setBoolean(object, result);
