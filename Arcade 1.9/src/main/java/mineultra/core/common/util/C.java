...
public class C
{
  public static String Scramble = Colorizer.Color("&k");
  public static String Bold = Colorizer.Color("&l");
  public static String Strike = Colorizer.Color("&m");
  public static String Line = Colorizer.Color("&n");
  public static String Italics = Colorizer.Color("&o");
