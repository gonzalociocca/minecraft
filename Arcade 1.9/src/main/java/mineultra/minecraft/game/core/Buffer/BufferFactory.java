...
import mineultra.minecraft.game.core.Buffer.Buffers.Burning;
...
public class BufferFactory
{
    ...
    public Buffer Ignite(final String reason, final LivingEntity ent, final LivingEntity source, final double duration, final boolean extend, boolean showIndicator) {
        showIndicator = false;
        return this.Manager.AddBuffer(new Burning(this.Manager, reason, ent, source, Buffer.BufferType.BURNING, 0, (int)(20.0 * duration), extend, Material.GHAST_TEAR, (byte)0, showIndicator));
    }
