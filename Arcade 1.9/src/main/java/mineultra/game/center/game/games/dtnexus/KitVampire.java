...
public class KitVampire extends Kit
{
    public KitVampire(final centerManager manager) {
        super(manager, "Vampire", KitAvailability.Blue, new String[] { "An assassin without heart" }, new Perk[] {new BACKSTAB(), new VAMPIRE(4), new SPEED(1), new FOOD(16), new FALLDAMAGE(6) }, EntityType.PLAYER, new ItemStack(Material.IRON_SWORD));
    }
