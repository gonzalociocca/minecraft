  ...
  extends Kit
{
  ...
  {
    super(manager, "Survivor Knight", KitAvailability.Free, new String[] {"Smash and kill through Zombies" }, new Perk[] {new IRONDEF(1.0D),new STRENGTH(1), new MAMMOTH() }, EntityType.ZOMBIE, new ItemStack(Material.IRON_SWORD));
  }
