  ...
  extends Kit
{
  ...
  {
    super(manager, "Survivor Archer", KitAvailability.Blue, new String[] {"Sobrevive con tu arco, y tus flechipollas!" }, new Perk[] {new FLETCHER(2, 8, true),new STRENGTH(1), new BARRAGE(5, 250L, true, false) }, EntityType.SKELETON, new ItemStack(Material.BOW));
  }
