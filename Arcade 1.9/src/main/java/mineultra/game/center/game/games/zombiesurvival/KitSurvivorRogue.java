  ...
  extends Kit
{
  ...
  {
    super(manager, "Survivor Rogue", KitAvailability.Green, new String[] {"You are weaker in combat, but very agile." }, new Perk[] {new LEAP("Leap", 1.0D, 1.0D, 8000L),new STRENGTH(1), new SPEED(0) }, EntityType.ZOMBIE, new ItemStack(Material.IRON_AXE));
  }
