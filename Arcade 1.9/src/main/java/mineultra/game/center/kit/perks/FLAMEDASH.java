    ...
    public void UpdateMovement() {
        ...
        while (dataIterator.hasNext()) {
            ...
            if (!UtilTime.elapsed(data.Time, 800L)) {
                ...
                data.Player.getWorld().playSound(data.Player.getLocation(), Sound.ENTITY_GENERIC_EXTINGUISH_FIRE, 0.6f, 1.2f);
            }
            else {
                ...
                data.Player.getWorld().playSound(data.Player.getLocation(), Sound.ENTITY_GENERIC_EXPLODE, 1.0f, 1.2f);
                dataIterator.remove();
            }
        }
    }
