...
public abstract class Kit implements Listener
{
    ...
    public String GetFormattedName() {
        return this.GetAvailability().GetColor() + Colorizer.Color("&l") + this._kitName;
    }
    ...
    public Entity SpawnEntity(final Location loc) {
        ...
        entity.setCustomName(this.GetAvailability().GetColor() + this.GetName() + " Kit" + ((this.GetAvailability() == KitAvailability.Blue) ? (ChatColor.GRAY + " (" + ChatColor.WHITE + "VIP" + ChatColor.GRAY + ")") : ""));
    ...
    public void DisplayDesc(final Player player) {
        ...
        UtilPlayer.message((Entity)player, Colorizer.Color("&aKit - &f&l" )+ this.GetName());
        String[] getDesc;
