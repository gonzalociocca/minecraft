    ...
    public void movePlayer(EntityPlayer entityplayer) {
        ...
        if (d2 >= 64.0D) {
            ...
            if (j1 != 0 || k1 != 0) {
                ...
                //MineLevel changed queue to linked list, try sorting. changed again due to iterator not being concurrent yet
    ...
    class PlayerChunk {
        ...
        public void a(Packet packet) {
            for (int i = 0; i < this.b.size(); ++i) {
                ...
                if (entityplayer != null && !entityplayer.chunkCoordIntPairQueue.contains(this.location)) {
