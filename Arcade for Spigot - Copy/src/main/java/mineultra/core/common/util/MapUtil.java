...
public class MapUtil
{
  ...
  public static void QuickChangeBlockAt(org.bukkit.World world, int x, int y, int z, int id, int data)
  {
    ...
    net.minecraft.server.v1_8_R2.Chunk c = ((CraftChunk)chunk).getHandle();
/*
    c.a(new BlockPosition(x & 0xF, y, z & 0xF), net.minecraft.server.v1_8_R2.Block.getById(id), data);
  ...
  */}
  ...
  public static void ResendChunksForNearbyPlayers(Collection<net.minecraft.server.v1_8_R2.Chunk> chunks)
  {
    int j;
 int i = 0;
    ...
    for (Iterator localIterator = chunks.iterator(); i < j; localIterator.hasNext() )
    {
      ...
      net.minecraft.server.v1_8_R2.Chunk c = (net.minecraft.server.v1_8_R2.Chunk)localIterator.next();
  ...
  public static net.minecraft.server.v1_8_R2.Chunk ChunkBlockChange(Location location, int id, byte data)
  {
    return ChunkBlockChange(location.getWorld(), location.getBlockX(), location.getBlockY(), location.getBlockZ(), id, data);
  }

  public static net.minecraft.server.v1_8_R2.Chunk ChunkBlockChange(org.bukkit.World world, int x, int y, int z, int id, byte data)
  {
    net.minecraft.server.v1_8_R2.Chunk c = ((CraftChunk)world.getChunkAt(x >> 4, z >> 4)).getHandle();
    net.minecraft.server.v1_8_R2.Block block = net.minecraft.server.v1_8_R2.Block.getById(id);
...
/*      net.minecraft.server.v1_8_R2.Block.getById(l1).f(c.world, new BlockPosition(j2, y, k2), i2);
    }
...
*/
  ...
  public static void UnloadWorld(JavaPlugin plugin, org.bukkit.World world)
  {
    ...
    Bukkit.getPluginManager().callEvent(new WorldUnloadEvent(((CraftWorld)world).getHandle().getWorld()));
      ...
      for (net.minecraft.server.v1_8_R2.Chunk chunk : ((CraftWorld)world).getHandle().chunkProviderServer.chunks.values()) {
