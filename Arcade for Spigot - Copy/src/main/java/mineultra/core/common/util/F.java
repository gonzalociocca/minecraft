...
public class F
{
  ...
  {
    return ChatColor.YELLOW+""+ChatColor.BOLD + module + "> " + C.mBody + body;
  }

  public static String tute(String sender, String body)
  {
    return ChatColor.YELLOW+""+ChatColor.BOLD + sender + "> " + C.cWhite + body;
  }
...
/*
  public static String help(String cmd, String body, Player player)
  {
