  ...
  extends Kit
{
  ...
  {
    super(manager, "Undead", KitAvailability.Hide, new String[] {"Just a standard Zombie..." }, new Perk[] {new LEAP("Leap", 1.0D, 1.0D, 8000L), new STRENGTH(1), new IRONDEF(1.0D), new REGENERATION(0) }, EntityType.ZOMBIE, new ItemStack(Material.STONE_AXE));
  }
