...
{
    public KitMaster(final centerManager manager) {
        super(manager, "Master", KitAvailability.Green, new String[] { "Master of all classes.. " }, new Perk[] { new ROPEDARROW("Roped Arrow", 1.0, 5000L),new FLETCHER(20, 5, true), new BARRAGE(10, 250L, true, false), new SPEED(1) }, EntityType.PLAYER, new ItemStack(Material.DIAMOND_AXE));
    }
    ...
    @Override
    public int GetCost() {
        return this.Manager.getConfig().getInt("kitprices.master");
    }
