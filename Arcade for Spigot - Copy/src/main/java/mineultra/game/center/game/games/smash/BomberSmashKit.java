...
public class BomberSmashKit extends Kit
{
    public BomberSmashKit(final centerManager manager) {
        super(manager, "Bomber", KitAvailability.Green, new String[] { "Launch TNT" }
                , new Perk[] {new BOMBER(40,1,-1),new SMASH("Smash",1,2500L) }
...
return Color.BLACK;
    ...
    @Override
    public int GetCost() {
        return this.Manager.getConfig().getInt("kitprices.bomber");
    }
}
