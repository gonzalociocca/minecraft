...
public class CombatManager implements Listener
{
	...
	private HashMap<Player, CombatLog> _active = new HashMap<Player, CombatLog>();
	private HashMap<String, ClientCombat> _combatClients = new HashMap<String, ClientCombat>();
