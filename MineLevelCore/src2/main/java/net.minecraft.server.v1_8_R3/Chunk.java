...
public class Chunk {
    ...
    public Chunk(World world, int i, int j) {
        ...
        if (!(this instanceof EmptyChunk)) {
            this.bukkitChunk = new org.bukkit.craftbukkit.v1_8_R3.CraftChunk(this);
        }
    }
    ...
    public TileEntity a(BlockPosition blockposition, Chunk.EnumTileEntityState chunk_enumtileentitystate) {
        return this.a(blockposition,chunk_enumtileentitystate,0);
    }
    public TileEntity a(BlockPosition blockposition, Chunk.EnumTileEntityState chunk_enumtileentitystate, int run) {
        // CraftBukkit start
        ...
        if (tileentity == null) {
            if (chunk_enumtileentitystate == Chunk.EnumTileEntityState.IMMEDIATE) {
                ...
                this.world.setTileEntity(blockposition, tileentity,run);
    ...
    public void a(BlockPosition blockposition, TileEntity tileentity) {
        ...
        if (this.getType(blockposition) instanceof IContainer) {
            ...
            System.out.println("Attempted to place a tile entity (" + tileentity + ") at " + tileentity.position.getX() + "," + tileentity.position.getY() + "," + tileentity.position.getZ()
                    + " (" + org.bukkit.craftbukkit.v1_8_R3.util.CraftMagicNumbers.getMaterial(getType(blockposition)) + ") where there was no entity tile!");
        ...
        while (iterator.hasNext()) {
            ...
            if ( tileentity instanceof IInventory )
            {
                for ( org.bukkit.entity.HumanEntity h : Lists.<org.bukkit.entity.HumanEntity>newArrayList((List<org.bukkit.entity.HumanEntity>) ( (IInventory) tileentity ).getViewers() ) )
                {
                    ...
                    {
                        ( (org.bukkit.craftbukkit.v1_8_R3.entity.CraftHumanEntity) h).getHandle().closeInventory();
                    }
                }
            }
            // Spigot End
