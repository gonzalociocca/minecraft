...
public class PlayerProfile {
    ...
    /* HUDs */
    public MobHealthbarType mobHealthbarType;
    public int scoreboardTipsShown;

    /* Skill Data */
    public final Map<SkillType, Integer>   skills     = new HashMap<SkillType, Integer>();   // Skill & Level
    public final Map<SkillType, Float>     skillsXp   = new HashMap<SkillType, Float>();     // Skill & XP
    public final Map<AbilityType, Integer> abilityDATS = new HashMap<AbilityType, Integer>(); // Ability & Cooldown
