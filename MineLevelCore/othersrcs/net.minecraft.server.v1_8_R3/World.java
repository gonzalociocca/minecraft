            ...
            if(nexttick%2 == 0){
                if(entity instanceof EntityAnimal){
                    if(entity instanceof EntityChicken){
                        ((EntityChicken)entity).bs-=1;
                    }
                    if(entity.ticksLived < 20){
                        ((EntityAnimal)entity).maxNoDamageTicks = 2;
                        if(((EntityAnimal)entity).getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).getValue() == 0.699999988079071D){
                            ((EntityAnimal) entity).getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).setValue(0.14D);
                        }
                ...
                if(entity.ticksLived < 20) {
                    ((EntityMonster)entity).maxNoDamageTicks = 2;
                    if(((EntityMonster)entity).getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).getValue() == 0.699999988079071D){
                        ((EntityMonster) entity).getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).setValue(0.14D);
                    }
                }
                if(entity.ticksLived > 36000L){
                    entity.die();
                }
                continue;
            }
