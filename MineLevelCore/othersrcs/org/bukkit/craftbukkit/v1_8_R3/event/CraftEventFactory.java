...
public class CraftEventFactory {
    ...
    public static PlayerBucketFillEvent callPlayerBucketFillEvent(EntityHuman who, int clickedX, int clickedY, int clickedZ, EnumDirection clickedFace, ItemStack itemInHand, net.minecraft.server.v1_8_R3.Item bucket) {
        return (PlayerBucketFillEvent) getPlayerBucketEvent(true, who, clickedX, clickedY, clickedZ, clickedFace, itemInHand, bucket);
    }

    private static PlayerEvent getPlayerBucketEvent(boolean isFilling, EntityHuman who, int clickedX, int clickedY, int clickedZ, EnumDirection clickedFace, ItemStack itemstack, net.minecraft.server.v1_8_R3.Item item) {
        Player player = (who == null) ? null : (Player) who.getBukkitEntity();
    ...
    public static Cancellable handleStatisticsIncrease(EntityHuman entityHuman, net.minecraft.server.v1_8_R3.Statistic statistic, int current, int incrementation) {
        ...
        Event event;
        if (statistic instanceof net.minecraft.server.v1_8_R3.Achievement) {
            if (current != 0) {
                return null;
            }
            event = new PlayerAchievementAwardedEvent(player, CraftStatistic.getBukkitAchievement((net.minecraft.server.v1_8_R3.Achievement) statistic));
        } else {
